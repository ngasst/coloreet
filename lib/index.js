    ...
    _createClass(Colorize, [
        ...
        },
        {
            ...
            value: function colorize(options, config) {
                ...
                if (typeof string !== 'string') throw new Error("Parameter {string} is required and must be of type \"string\"! Received ".concat(string, " of type ").concat(typeof string === "undefined" ? "undefined" : _typeof(string)));
                // is tailwind
